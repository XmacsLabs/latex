...
(kbd-commands
  ...
  ("cc" "Make Á" (emulate-keyboard "cedilla c"))
  ("'E" "Insert …" (emulate-keyboard "acute E"))
  ("'e" "Insert È" (emulate-keyboard "acute e"))
  ("`A" "Insert ¿" (emulate-keyboard "grave A"))
  ("`E" "Insert »" (emulate-keyboard "grave E"))
  ("`U" "Insert Ÿ" (emulate-keyboard "grave U"))
  ("`a" "Insert ‡" (emulate-keyboard "grave a"))
  ("`e" "Insert Ë" (emulate-keyboard "grave e"))
  ("`u" "Insert ˘" (emulate-keyboard "grave u"))
  ("^A" "Insert ¬" (emulate-keyboard "hat A"))
  ("^E" "Insert  " (emulate-keyboard "hat E"))
  ("^I" "Insert Œ" (emulate-keyboard "hat I"))
  ("^O" "Insert ‘" (emulate-keyboard "hat O"))
  ("^U" "Insert €" (emulate-keyboard "hat U"))
  ("^a" "Insert ‚" (emulate-keyboard "hat a"))
  ("^e" "Insert Í" (emulate-keyboard "hat e"))
  ("^i" "Insert Ó" (emulate-keyboard "hat i"))
  ("^o" "Insert Ù" (emulate-keyboard "hat o"))
  ("^u" "Insert ˚" (emulate-keyboard "hat u"))
  ("S" "Make ü" (emulate-keyboard "S-F5 p"))
  ("aa" "Insert Â" (insert "Â"))
  ("ae" "Insert ae" (emulate-keyboard "S-F5 a"))
  ("dh" "Insert √∞" (insert "<#00F0>"))
  ...
  ("ss" "Insert ˇ" (emulate-keyboard "S-F5 s"))
  ("sz" "Insert ˇ" (emulate-keyboard "S-F5 s"))
  ("th" "Insert <#00FE>" (insert "<#00FE>"))
  ("AA" "Insert ≈" (insert "≈"))
  ("AE" "Insert AE" (emulate-keyboard "S-F5 A"))
  ("DH" "Insert √ê" (insert "<#00D0>"))
